    ...
    modules: [
      {
        ...
        duration: 8,
        tags: ["zorglandschap", "basiskennis", "zorgstelsel"]
      },
      {
        id: "1.2",
        title: "Zorgverzekeringswet & financieringsstromen",
        duration: 10,
        tags: ["zvw", "financiering", "verzekeraars"]
      },
      {
        id: "1.3",
        title: "Belangrijkste spelers: ziekenhuizen, huisartsen, VVT",
        duration: 7,
        tags: ["ziekenhuizen", "huisartsen", "vvt", "ggz"]
      },
      {
        id: "1.4",
        title: "Toezichthouders: NZa, IGJ, AP",
        duration: 6,
        tags: ["nza", "igj", "ap", "toezicht"]
      }
    ]
  },
  {
    ...
    modules: [
      {
        ...
        duration: 8,
        tags: ["infrastructuur", "lsp", "twiin", "vzvz", "mitz"]
      },
      {
        id: "3.2",
        title: "LSP: Landelijk Schakelpunt in detail",
        duration: 10,
        tags: ["lsp", "vzvz", "uitwisseling"]
      },
      {
        id: "3.3",
        title: "Twiin: Vertrouwensnetwerk en usecases",
        duration: 9,
        tags: ["twiin", "vertrouwensnetwerk", "uitwisseling"]
      },
      {
        id: "3.4",
        title: "Mitz: Toestemmingsvoorziening",
        duration: 7,
        tags: ["mitz", "toestemming", "consent"]
      },
      {
        id: "3.5",
        title: "AORTA: Basisinfrastructuur",
        duration: 8,
        tags: ["aorta", "infrastructuur", "nictiz"]
      },
      {
        id: "3.6",
        title: "Koppeltaal (GGZ), MedMij (PGO's)",
        duration: 9,
        tags: ["koppeltaal", "medmij", "pgo", "ggz"]
      },
      {
        id: "3.7",
        title: "Zorgadresboek, UZI, BSN in de zorg",
        duration: 6,
        tags: ["zorgadresboek", "uzi", "bsn", "identificatie"]
      }
    ]
  },
  {
